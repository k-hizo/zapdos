...
[Reactions]
  [./Argon]
    ...
    reactions = 'em + Ar -> em + Ar*        : {(2.48e-14*(e_temp^0.33))*exp(-12.78/e_temp)} [-12.14] (reaction1)
                em + Ar -> em + em + Ar+   : {(2.34e-14*(e_temp^0.59))*exp(-17.44/e_temp)} [-15.76] (reaction2)'
...
[AuxKernels]
  ...
  [./Ionization]
    ...
    variable = Ionization
    property = 'k1_em + Ar -> em + em + Ar+'
  [../]

  [./Function]
    type = ParsedAux
    variable = Bohmvelocity
    args = 'e_temp'
    function = 'sqrt(1.602e-19*e_temp/6.64e-26)'
  [../]

  [./Function2]
    type = ParsedAux
    variable = ngtimes_effdia
    args = 'Ionization Bohmvelocity'
    function = 'Bohmvelocity/Ionization'
  [../]
