...
[Reactions]
  [./Argon]
    ...
    reactions = 'em + Ar -> em + Ar         : {(2.336e-14)*(e_temp^1.609)*(exp(0.0618*log(e_temp)^2-0.01171*log(e_temp)^3))* 6.022e23} [elastic] (reaction1)
                em + Ar -> em + Ar*        : {(2.48e-14)*(e_temp^0.33)*(exp(-12.78/e_temp))* 6.022e23} [-12.14]  (reaction2)
                em + Ar -> em + em + Ar+   : {(2.34e-14)*(e_temp^0.59)*(exp(-17.44/e_temp))* 6.022e23} [-15.76]  (reaction3)
                em + Ar -> Ar4s + em     : {5.0e-15*(e_temp^0.74)*(exp(-11.56/e_temp))* 6.022e23} (reaction4)
                em + Ar4s -> Ar + em     : {4.3e-16*(e_temp^0.74)* 6.022e23} (reaction5)
                em + Ar4p -> Ar + em     : {1.4e-14*(e_temp^0.71)*(exp(-13.2/e_temp))* 6.022e23} (reaction6)
                Ar4s + em -> Ar4p + em : {8.9e-13*(e_temp^0.51)*(exp(-1.59/e_temp))* 6.022e23} (reaction7)
                Ar4p + em -> Ar4s + em : {3e-13*(e_temp^0.51)* 6.022e23} (reaction8)
                em + Ar4s -> Ar+ + em + em : {6.8e-15*(e_temp^0.67)*(exp(-4.2/e_temp))* 6.022e23} ) (reaction9)
                em + Ar4p -> Ar+ + em + em : {1.8e-13*(e_temp^0.61)*(exp(-2.61/e_temp))* 6.022e23} (reaction10)
                Ar4p -> Ar : {3.2e7}
                '
                #em + Ar -> em + Ar*        : EEDF [-11.56] (reaction1)
...
[Functions]
  [./potential_bc_func]
    type = ParsedFunction
    value = '0.250*sin(2*3.1415926*13.56e6*t)'
  [../]
  [./ion_density_ic_func]
    type = ParsedFunction
